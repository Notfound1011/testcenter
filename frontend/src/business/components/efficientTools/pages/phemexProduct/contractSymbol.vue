    ...
    <ms-main-container>
      <div class="configTabContainer">
        ...
        <el-table
          ...
          <el-table-column label="contractSize" prop="contractSize" align="center"></el-table-column>
          <el-table-column label="lotSize" prop="lotSize" align="center"></el-table-column>
          ...
          <el-table-column label="minPriceEp" prop="minPriceEp" align="center"></el-table-column>
          <el-table-column label="maxPriceEp" prop="maxPriceEp" align="center"></el-table-column>
          <el-table-column label="maxOrderQty" prop="maxOrderQty" align="center"></el-table-column>
  ...
  methods: {
    async getSymbolConfig (overrideEnv='') {
      ...
      const { data: symbolConfigRes } = await this.$axios.get(
        `/pyServer/public/test-data/tools/get-symbol-config?env=${apiEnv}&symbol=BTC&getAll=true&symbolType=Perpetual`,
      ).catch((error) => {
